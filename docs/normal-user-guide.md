...
13. If setup was interrupted, keep the GPTK DMG mounted and click **Begin GPTK Install** again. The app should stay on the setup checklist until the runner and GPTK 3.0 runtime are copied and verified.
