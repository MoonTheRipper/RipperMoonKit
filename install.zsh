...
write_backup_readme() {
  {
    ...
    print -r -- "- ${install_bin}/gptk-gptk4"
...
create_backup() {
  ...
  backup_restore_path "${install_bin}/gptk-gptk4" "home/bin/gptk-gptk4" "GPTK 4 / Wine 11 runner builder"
...
install_toolkit_files() {
  ...
  install -m 755 "${repo_dir}/bin/gptk-gptk4" "${install_bin}/gptk-gptk4"
